...
class Profile extends Component {
    ...
    render() {
        ...
        <Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggle} direction="down">
            <DropdownToggle className="dropdown-title dropdown-text" color="light" caret><img className="profile-pic-small me-2" src="/assets/images/profile-pic.png"/>dotalim0204</DropdownToggle>
