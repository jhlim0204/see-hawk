...
export class DataManager {
     ...
     * @return {favourite[]} -  returnList of favourites
     */
     ...
     * @returns {hawkerCentre[]} - returns hawkercentre to be retrieved, else returns null 
     */
     ...
     * @return {hawkerCentre[]} - returns list of hawkercentre
     */
